...
export const metadata: Metadata = {
    title: "Policy",
    description: "Learn about TinkProduct Online's policies regarding privacy, terms of service, and more. We are committed to safeguarding your privacy and ensuring a secure online experience.",
        ...
        <div className="bg-gray-100 w-[90%] mx-auto rounded-md mt-10 shadow-lg">
            <div className="container mx-auto px-4 py-8">
                ...
                <ul className="list-disc list-inside mb-4">
                    <li>Phy Lymann and contact information</li>
                ...
                <p className="mb-4">
                    A cookie is a small file that asks permission to be placed on your computer is hard drive. Once you agree,
                    the
                    file
